...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = "Plot 1. Horse Population by Province"}
...
kable(max_horses, 
      caption = "Table 1. Maximum and minimum number of horses by province")
```

Below we zoom in and look at the province of Alberta:

```{r plot province, fig.width=5, fig.height=4, fig.cap = "Plot 2. Horse Population for Province"}
